...
pessoasInput.addEventListener("input", receberValorContaPessoas)

function receberValorContaPessoas(evento) {
...
function calcular() {
    if(conta !== 0 && porcentagem !== 0 && pessoas !== 0) {
        const strongGorjetalTotal = document.querySelector(".gorjeta-total > strong")
        strongGorjetalTotal.innerHTML = `R$ ${(conta * porcentagem / pessoas).toFixed(2)}`
